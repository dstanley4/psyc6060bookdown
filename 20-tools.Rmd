...
You can pre-register your study and upload your study materials via a free account at the [OSF](https://osf.io). Don't forget you should also pre-register your outlier strategy. See [@leys2019classify] for guidance.
...
## Journal ranking via the TOP Factor

You can see journal rankings based on the Transparency and Openness Promotion Guidelines at the [Top Factor website](https://www.topfactor.org).

## Writing articles

I suggest you check out [Writing Empirical Articles: Transparency, Reproducibility, Clarity, and Memorability](https://doi.org/10.1177%2F2515245918754485) for excellent advice on writing articles (pictured below). Conversely, I suggest you AVOID "Writing the Empirical Journal Article" by Daryl Bem because this article has been described by some as a "how to guide" for p-hacking (i.e., finding the prettiest path in the garden of forking analysis paths).
