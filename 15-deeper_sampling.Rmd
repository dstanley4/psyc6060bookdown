...
$$
\begin{aligned} 
F &= \frac{\frac{\sigma_{people}^2}{n} + \sigma_{\mu_A}^2}{\frac{\sigma_{people}^2}{n}}\\
\end{aligned}
$$

But some textbooks show it in another form - which doesn't make sense conceptually but is mathematically the same. Below I show you how the conceptually meaningful approach used above can be converted to the format shown in most books. Note the change in notation in the last line.
