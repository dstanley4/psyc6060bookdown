...
Note that when the population mean are the same, and $\sigma_{A}^2$ becomes $0$, the "Expected value" is becomes the same for both formulas. That is, they are both estimates of the same quantity, namely, $\frac{\sigma_{people}^2}{n}$. We examined that situation in the last chapter.

In this chapter, we examine the situation where $\sigma_{A}^2>0$. That is, that situation where the two formulas are estimates of different quantities.
