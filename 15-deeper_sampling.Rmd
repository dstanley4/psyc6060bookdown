...
Consequently, we say the ANOVA is significant. That is, we begin by assuming the population means are all the same, our find our study result is incredibly unlikely. Consequently, we reject the assumption, that the population means are all the same.
