...
-   Approach 1 Estimated Observed Variance: Total variance of sample means calculated using sample means and the variance formula

-   Approach 2 Estimated Expected Variance: Variance of sample means, due to random sampling error, calculated using CLT shortcut formula
