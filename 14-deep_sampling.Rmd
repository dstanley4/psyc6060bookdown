...
Fortunately we don't need to obtain an infinite number of sample means to determine the variance of the distribution of sample means. There is a "shortcut formula" we can used based on the the Central Limit Theorem (CLT). More specifically, the variance of the distribution of sample means depends on both the number of people in each sample ($n$) and the variance of the people heights in the population ($\sigma_{people}^2$).
