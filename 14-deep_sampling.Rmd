...
Below I present a graph of these ratios, Figure \@ref(fig:graph1pop). You can see there is a wide range of ratios that occur. Note that this is shape of the distributions when we have:
