...
When there is *one* **population of people** there is a single distribution of sample means that corresponds to that population. There are two methods for calculating the variance of this distribution of sample means.
...
|:-------------:|:-----------------------------:|:------------------------------------------------:|
| 1             | `r sample_mean`      | `r est_pop_var`                         |
| 1             | `r sample_mean2`     | `r est_pop_var2`                        |
| 1             | `r sample_mean3`     | `r est_pop_var3`                        |
...
Thus, the variance of the distribution of sample means ($\sigma_{\bar{x}}^2$) is estimated, using Method 1, to be  $s_{\bar{x}}^2 = `r method1_var`$. Remember though `r method1_var` is just an estimate of the population value.
