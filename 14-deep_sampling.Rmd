...
Compare the value we obtained to the values in $F$-table at 2 and 12 degrees of freedom. An $F$-table is a table of $F_{critical}$ values. You can see the value in the table is 3.89 - this is the correct value. Our estimate is 3.88 which is very close to the correct value of 3.89. Our value of 3.88 is off a bit from the 3.89 in the $F$-table because we only use 100,000 samples and not an infinite number of samples.
