...
But if we imagine a world where we could obtain the full infinite set of sample means we would use the formula as below: 
...
Thus, the "population" variance of the distribution of sample means ($\sigma_{\bar{x}}^2$, see Figure 1B) is **calculated**, based an infinite number of sample means ($A = \infty$) using Method 1, to be $\sigma_{\bar{x}}^2 = 6.252944$. 
...
Thus, the "population" variance of the distribution of sample means ($\sigma_{\bar{x}}^2$, see Figure 1B) is **calculated**, using Method 2 the CLT shortcut, to be $\sigma_{\bar{x}}^2 = 6.252944$. 
...
You can see the ratio comparing these two methods below is 1.00 - so we conclude two methods produced the same result. [expand]
...
| 2             |  25 | `r sample_mean2`     | `r est_pop_var2`                        |
| 3             |  25 | `r sample_mean3`     | `r est_pop_var3`                        |
