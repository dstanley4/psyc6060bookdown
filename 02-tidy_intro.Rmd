...
#NOTICE: We having increased the number of digits in the output
options(pillar.sigfig = 6)
...
In a future chapter you will see how we can select factors using where(is.factor).
