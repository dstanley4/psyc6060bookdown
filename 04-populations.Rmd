...
png(filename = "ch_populations/images/rho_example.png",
    ...
    height = 7*300,
    res = 300)
gridExtra::grid.arrange(r30plot, r50plot, r70plot)
dev.off()
...
2. Are the formula (excluding notation differences) always the same for parameters and statistics? If not, explain why not? 
