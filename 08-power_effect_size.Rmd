...
Another approach to determine the effect size using in yourn independent groups t-test power / sample size analysis is to determine the smallest effect that would have been significant in the previous study [@lakens2018equivalence]. We do that with the code below:
...
* Effect size estimate from the from the small telescope approach ($\delta = .17$)
...
This indicates that with a sample size of 298 that only $d$-values greater than $d$ = 0.10 (rounded) will be significant. 
