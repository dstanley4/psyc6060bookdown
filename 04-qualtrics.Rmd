...
Now you need to tweak the survey using the Qualtrics interface. Recall when you import items into a matrix style question Qualtrics drops the item names. **You need to manually restore the item names now for matrix questions.**
