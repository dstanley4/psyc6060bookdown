...
We don't have a participant identification column, so make one:
...
The participant identification number in the id column is a numeric column, but we want it to be a factor. 
...
Based on that output create a factor:
