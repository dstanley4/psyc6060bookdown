...
From this output we see the population parameters are:
...
Notice that the population standard deviation is the same for both populations, so there is only one population standard deviation.
