...
INSERT CHART SUMMING UP PARAMETERS
...
&= \frac{(10 -1)s_{male}^2 + (10 -1)s_{female}^2}{10 + 10 -2} \\
&= -999
\end{aligned}
$$
...
We calculate an unbiased estimate of the population standardized mean difference using Formula \@ref(eq:samplesmdunbiasedch5).

$$
\begin{aligned}
d_{unbiased}  &= \frac{\bar{x}_{males} - \bar{x}_{females}}{s_{pooled}} \times [1 - \frac{3}{4(n_{males} + n_{females})-9}] \\
&= \frac{\bar{x}_{males} - \bar{x}_{females}}{-999} \times [1 - \frac{3}{4(10 + 10)-9}] \\
\end{aligned}
$$


# Variability in $d$-values

* bias check using average

* histogram showing enormous range of d-vaoues

* min max of d showing interpretational problems
