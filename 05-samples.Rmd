...
gmale <- ggplot(data = male_pop_data,
  ...
  geom_segment(x = 165, xend = 165, y = 0, yend = 150000, size = 1, linetype = "dotted") +
  geom_segment(x = 180, xend = 180, y = 0, yend = 150000, size = 1) +
  ...
  coord_cartesian(ylim = c(0, 150000), xlim = c(120, 220))
