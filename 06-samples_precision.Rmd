...
ggd10 <- ggplot(data = many_samples_d_10,
  ...
  labs(y = "Frequency", x = "sample d.unbiased", title = "Sampling distribution d.unbiased (n = 10)") +
...
ggd100 <- ggplot(data = many_samples_d_100,
  ...
  theme_classic() +
  scale_x_continuous(breaks = seq(0, 3.5, by = .25)) +
  labs(y = "Frequency", x = "sample d.unbiased", title = "Sampling distribution d.unbiased (n = 100)") +
...
```{r ddistributions, echo=FALSE, out.width = "80%", fig.cap = "d.unbiased sampling distributions"}
knitr::include_graphics("ch_samples_precision/images/d_distribs.png")
```
