...
&= \frac{`r var1` + `r var2` +`r var3` +`r var4` +`r var5` +`r var6` }{6} \\ 
&= `r mean(var_all)`
\end{aligned}
$$
...
### Expected Variance $B$: Preparation
...
### Observed Variance $A$ (total variance)
...
### Observed Variance $B$ [total variance]
...
### Observed Variance $AB$ [total variance]
