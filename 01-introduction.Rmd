...
# Introduction
We will use the statistical analysis software R in this course with the interface provided by R Studio. You can access R Studio using the website [R Studio Cloud](http://www.rstudio.cloud).
