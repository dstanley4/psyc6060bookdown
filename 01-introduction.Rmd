...
Welcome to PSYC6060! In this course, we will use the statistical software R with the interface provided by R Studio. You can access R Studio using the website [R Studio Cloud](http://www.rstudio.cloud).
