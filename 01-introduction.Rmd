...
Welcome to PSYC6060! In this course, we will use the statistical analysis software R in this course with the interface provided by R Studio. You can access R Studio using the website [R Studio Cloud](http://www.rstudio.cloud).
...
```{r join, fig.cap="Screenshot of join message", echo = FALSE, out.width="85%"}
...
```{r welcome, fig.cap="Screenshot of welcome messag", echo = FALSE, out.width="85%"}
...
```{r assignment, fig.cap="Screenshot of starting first assignment", echo = FALSE, out.width="85%"}
